...
spending_data <- historical_spending |>
  ...
  select(-c(PerPerson)) |>
  pivot_longer(-Year, names_to = "Categoría", values_to = "Amount") |>
...
title <- glue::glue("<span style='font-family:{body_font}; font-size: 32pt; font-weight: bold;'>**¿Cómo gasta la gente (dinero en) el día de San Valentín?**</span>")

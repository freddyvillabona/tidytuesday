...
p <- ggplot() +
  ...
  labs(x="", 
       y="", 
       title = "Las razas de perros más populares", 
       tag = trimmer("La mayoría de los labradores retrievers han ocupado constantemente el primer puesto entre las razas de perros más populares. Los bulldogs franceses han experimentado un impresionante ascenso en la clasificación hasta convertirse en la segunda raza más popular en 2020.\n\n\nN. programandoenr | Data: American Kennel Club\n\nImage:Lucca", 40)) +
